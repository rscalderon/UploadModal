...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React47.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React47.useRef(false);
  const handleEntering = React47.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React47.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React47.useCallback(() => {
    dispatch("exiting");
  }, []);
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XKLSEKOG.js.map
